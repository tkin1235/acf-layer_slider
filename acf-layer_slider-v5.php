...
class acf_field_layer_slider extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Layer Slider', 'acf-layer_slider');
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-layer_slider'),
		);
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-layer_slider'),
		}
